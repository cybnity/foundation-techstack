...
| [ReactJS](https://reactjs.org/) |18.2.0|POC state: OK build/run based on NodeJS sdk|- [Documentations](https://reactjs.org/docs/getting-started.html)<br>- [Node.js and NPM installation](https://nodejs.org/en/)<br>- [Node.js documentation](https://nodejs.org/docs/latest-v17.x/api/)|
...
| [Keycloak](https://www.keycloak.org/) |18.0.2| |- based on Bitnami Docker image<br>- [Extensions](https://www.keycloak.org/extensions.html)<br>- [Theming extension with React](https://www.keycloakify.dev/)<br>- PostgreSQL (14.05 version) docker image based on Debian|
...
|Asset Control & SSO server|Security Services|- Keycloak<br>- PostgreSQL database<br>- Temurin JVM<br>- Debian Linux OS<br>- Docker Image<br>- MicroK8s|Token management for front/backend's user access|- TODO: HTTPS configuration, MicroK8s execution|
