...
| [ReactJS](https://reactjs.org/) |18.2.0|POC state: OK build/run based on NodeJS sdk|- [Documentations](https://reactjs.org/docs/getting-started.html)<br>- [Node.js and NPM installation](https://nodejs.org/en/)<br>- [Node.js documentation](https://nodejs.org/docs/latest-v17.x/api/)<br>- react-keycloak/web|
...
| [Keycloak](https://www.keycloak.org/) |18.0.2| |- based on Bitnami Docker image<br>- [Extensions](https://www.keycloak.org/extensions.html)<br>- [Theming extension with React](https://www.keycloakify.dev/)<br>- PostgreSQL (14.05 version) docker image based on Debian<br>- "keycloak-js" adapter|
...
| :--- | :--- | :--- | :--- | :--- |
|Asset Control FrontEnd UI server|Web Reactive FrontEnd|- Google Chrome web browser<br>- ReactBootstrap<br>- Keycloak js module <br>- ReactJS<br>Vert.x Event Bus Client<br>- NodeJS| |Integration & runtime OK with Vert.x event bus client ensuring call to Asset Control Backend UI server<br>- TODO: HTTPS with SSO integrated, packaged Docker image, MicroK8s execution|
