...
| [Apache Kafka](https://kafka.apache.org/) |2.7.0| |- [Documentations](https://kafka.apache.org/documentation/)<br>- POC state: OK build/run in cluster mode, based on Debian, and linked via Zookeeper|
